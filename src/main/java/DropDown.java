...
public class DropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("picturecontainer")).sendKeys("C:\\Users\\sande\\Desktop\\monument valley.jpeg");
...
//	else
	//{
		//	driver.findElement(By.xpath("//*[@id=selectgold\\following-sibling::span]")).click();
	//	}
	//elseif(metal.equals("Platinum"))
	//{
