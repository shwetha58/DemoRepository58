...
public class DropDown {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		//driver.findElement(By.xpath("//*[@id=\"picture\"]")).sendKeys("Desktop\\monument valley.jpeg");
		...
		Thread.sleep(2000);
		//using actions class selecting a radio button
		
		WebElement mouseover=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tfoot/tr/th[2]/label[4]/span"));
